...
#   trinut sleeve center: (0, 0, 0.0687) -> hand root (0, 0.08, 0.204)
...
# (trinut circumradius ~0.021, driver handle r ~0.0125).
REVO3_HAND_NUTBOLT_CFG = _make_hand_cfg({
    ...
    "right_index_MPR_joint": -0.25, "right_index_MCP_joint":  1.30,
    ...
    "right_ring_MPR_joint":   0.20, "right_ring_MCP_joint":   1.05,
    "right_ring_PIP_joint":   0.30, "right_ring_DIP_joint":   0.05,
    "right_little_MPR_joint": 0.25, "right_little_MCP_joint": 1.30,
    "right_little_PIP_joint": 0.40, "right_little_DIP_joint": 0.05,
}, HAND_INIT_POS_NUTBOLT)

REVO3_HAND_DRIVER_CFG = _make_hand_cfg({
    "right_thumb_CMP_joint":  1.65, "right_thumb_CMR_joint":  1.35,
    "right_thumb_MCP_joint":  0.50, "right_thumb_PIP_joint":  0.35,
    "right_thumb_DIP_joint":  0.05,
    ...
    "right_middle_PIP_joint": 0.35, "right_middle_DIP_joint": 0.05,
    "right_ring_MPR_joint":   0.20, "right_ring_MCP_joint":   1.10,
    "right_ring_PIP_joint":   0.35, "right_ring_DIP_joint":   0.05,
    "right_little_MPR_joint": 0.25, "right_little_MCP_joint": 1.35,
