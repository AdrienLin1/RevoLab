...
gym.register(
    id="BrainCo-Direct-Revo3-TactileRotate-Ball-v0",
    entry_point=f"{__name__}.revo3_hand_tactile_rotate_env:Revo3HandTactileRotateEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.revo3_hand_tactile_rotate_env_cfg:"
...
gym.register(
    id="BrainCo-Direct-Revo3-TactileRotate-Cylinder-v0",
    entry_point=f"{__name__}.revo3_hand_tactile_rotate_env:Revo3HandTactileRotateEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
