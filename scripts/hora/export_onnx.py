...
Stage1 IO:  obs[B,141] + priv_info[B,priv_dim] → action[B,21]
...
from BrainCo_DexHand.algo.hora.models.models import ActorCritic, resolve_tactile_encoder_type
from BrainCo_DexHand.algo.hora.models.running_mean_std import RunningMeanStd


DEFAULT_ACTOR_UNITS = [512, 256, 128]
DEFAULT_PRIV_UNITS = [256, 128, 32]
DEFAULT_PRIV_DIM = 8
DEFAULT_OBS_DIM = 141
...
def _build_net_config(cfg: Any | None, stage: str, obs_dim: int, actions_num: int) -> dict[str, Any]:
    ...
    network_cfg = _get_cfg_value(cfg, "train.network", None)
    tactile_type, tactile_cfg = resolve_tactile_encoder_type(network_cfg or {})
